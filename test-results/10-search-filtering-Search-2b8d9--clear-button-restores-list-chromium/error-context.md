...
- Name: 10-search-filtering.spec.ts >> Search & Filtering (PRP 08) >> search is case-insensitive and clear button restores list
- Location: tests\10-search-filtering.spec.ts:24:7
